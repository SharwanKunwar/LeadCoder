  ...
  return (
    <MainLayout>
      <div className="flex justify-between items-center mb-5">
        <p className="font-medium">Showing {currentCards.length} concepts</p>
      ...
      <div className="grid grid-cols-3 gap-6">
        {currentCards.map((concept) => (
          ...
          >
            <div>
              <h2 className="text-lg font-semibold mb-2">{concept.title || "Untitled"}</h2>
              <p className="text-sm text-gray-300 mb-4">{concept.description || "No description"}</p>
            </div>
      ...
      <div className="flex justify-center gap-3 mt-6 text-white">
        ...
        {[...Array(totalPages)].map((_, i) => (
          <Button
            ...
            className={currentPage === i + 1 ? "bg-indigo-500" : "bg-gray-400"}
          >
            {i + 1}
          </Button>
        ))}
