    ...
    <div className='bg-[#182430] h-[70vh] rounded-xl grid grid-cols-1 grid-row-1 gap-2 py-2 p-5 mastBrightShadow'>
      ...
      <div className='h-[10vh] flex flex-col justify-center gap-3'>
        ...
        <div className="bg-[#233648] rounded-lg w-full h-[35px] flex justify-start items-center mastBrightShadow focus-within:border border-white">
          <div className="rounded-full pl-2 w-[50px] h-[50px] flex justify-center items-center">
            <i className="ri-search-line text-[#8B8D93]"></i>
          </div>
          <div>
      ...
      <div className="flex flex-col gap-3 text-white font-medium py-3">
        ...
        >
          <Radio className="custom-radio !text-white" value="Beginner">Beginner</Radio>
          <Radio className="custom-radio !text-white" value="Intermediate">Intermediate</Radio>
          <Radio className="custom-radio !text-white" value="Advanced">Advanced</Radio>
        </Radio.Group>
      </div>
