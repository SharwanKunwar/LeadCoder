...
const MainLayout = ({ children }) => {
    ...
    // Check if path matches `/concepts/:id`
    const isConceptDetailPage = /^\/concepts\/\d+$/.test(location.pathname);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className={`flex flex-1 px-20 ${ isConceptDetailPage ? "flex-row-reverse" : "flex" }`}>
